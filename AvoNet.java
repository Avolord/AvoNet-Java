...
public class AvoNet {
	...
	public void Benchmark(String type, int iterations) {
		switch (type) {
		case "guess":
	...
	private void Benchmark_guess(int iterations) {
	...
	private void Benchmark_train(int iterations) {
		console.log("Preparing data...");
		double prepare = System.nanoTime();
	...
	private void Benchmark_full(int iterations) {
		console.log("Preparing data...");
		double prepare = System.nanoTime();
